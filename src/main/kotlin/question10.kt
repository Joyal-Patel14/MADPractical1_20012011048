...
fun main() {
    ...
    val car1 = Car("Jaguar, 2018","Joyal",105, 10000.0,98950.0)
    car1.displayCarInfo()
    println("Creating Car Class Object car2 in next line")
    val car2 = Car("Hyundai, 2019","Aryan",20, 400000.0,399800.0)
    car2.displayCarInfo()
//    val car3 = Car("Toyota, 2017","KJS",100,1080000.0,1079000.0)
//    val car4 = Car("Maruti, 2020","NPP",200,4000000.0,3998000.0)
    println("\n********** ArrayList of Car **********")
    val carlist = ArrayList<Car>()
    carlist.add(Car("Audi, 2017","KJS",100,1080000.0,1079000.0))
    carlist.add(Car("Honda, 2020","NPP",200,4000000.0,3998000.0))
